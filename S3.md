...
* Bucket → a specific S3 instance (the container you store your files in)
* Objects →  data ‘items’
* Keys → an object’s name
* Values → the content of the object
...
* Netflix: data lake for big data analytics
* Airbnb: backup data, user pictures
* The Weather Channel: weather data from hundreds of sources
